...
_, test_loader = datasets.prepare_cifar100_loaders(transform)
...
# load models --------------------------------------------------------
fp32_model_filename = 'alexnet_cifar100_acc67.pt'
qtz_model_filename = 'alexnet_qat_cifar100_acc70.pt'
#qtz_model_filename = 'vgg16_imagenet_qtz_histogram.pt'
...
#fp32_model = vgg16_utils.create_vgg16_model()
fp32_model.eval()
